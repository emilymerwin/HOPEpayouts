...
for i, row in enumerate(reader):
	...
	tempArr = []
	tempArr.append(row['fiscyear'])
	tempArr.append(round(float(row['hopepays'])))
	tempArr.append(round(float(row['tuitionfees'])))
	tempArr.append(round(float(row['studentowes'])))
...
print "JSON parsed!"  
# Save the JSON  
f = open( 'CSVtoJSONwithParsing_arrayversion.json', 'w')  
f.write(out)  
print "JSON saved!"